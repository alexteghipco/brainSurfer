...
*NOTE* This software is provided as is with no guarantee of any kind. I built it to display some brains for me, and while I've tried to make it as user-friendly as possible, it's still in the early stages of being updated, and may not work with your particular machine/setup. The code has been updated to support Windows OS, but may hasn't been extensively tested there. Please see the bugs section for a full list of problems I am currently working on fixing. 
