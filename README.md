...
One neat trick that brainSurfer performs is that it can save any file type you load in (except surfaces) as any of the file types it is compatible with.
