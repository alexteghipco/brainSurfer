function [underlay, overlay] = plot3dOverlay(inData, n, w, limits, brainFile, brainCurvFile)
...
%
% plot3dOverlay(inData, n, w, limits) : n represents the length of each
...
% plot colorcube
if isempty(limits)
    [rgb_out, data_out, data_rgb_out] = colorcubes(n, w, inData);
else
    [rgb_out, data_out, data_rgb_out] = colorcubes(n, w, inData, limits);
end
...
underlay.SpecularStrength = 0;
underlay.SpecularExponent = 10;
underlay.SpecularColorReflectance = 1;
underlay.DiffuseStrength = 0.85;
underlay.AmbientStrength = 0.5;
