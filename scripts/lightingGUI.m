...
% LIGHTINGGUI MATLAB code for lightingGUI.fig
%      LIGHTINGGUI, by itself, creates a new LIGHTINGGUI or raises the existing
%      singleton*.
%
%      H = LIGHTINGGUI returns the handle to a new LIGHTINGGUI or the handle to
%      the existing singleton*.
%
%      LIGHTINGGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in LIGHTINGGUI.M with the given input arguments.
%
%      LIGHTINGGUI('Property','Value',...) creates a new LIGHTINGGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before lightingGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to lightingGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help lightingGUI
