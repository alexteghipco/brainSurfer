function [lh_proj_data, rh_proj_data] = CBIG_RF_projectVol2fsaverage(input, interp, lh_map, rh_map)

% Usage: [lh_proj_data, rh_proj_data] = CBIG_RF_ProjectVol2fsaverage(input, interp, lh_map, rh_map)
%
...
% EXAMPLE USAGE
% -------------
% >> [lh_proj_data, rh_proj_data] = CBIG_RF_projectVol2fsaverage('MNI_probMap_ants.central_sulc.nii.gz');
...
% >> MRIwrite(data, 'MNI2fsaverage_probMap_ants.central_sulc.nii.gz');
% Then call freeview in terminal:
% freeview -f $FREESURFER_HOME/subjects/fsaverage/surf/lh.inflated:overlay=MNI2fsaverage_probMap_ants.central_sulc.nii.gz
%
% Written by Wu Jianxiao and CBIG under MIT license: https://github.com/ThomasYeoLab/CBIG/blob/master/LICENSE.md
% Edited by Alex Teghipco to omit reference to freesurfer directory

% Function usage
if nargin < 1
    disp('usage: [lh_proj_data, rh_proj_data] = CBIG_RF_projectVol2fsaverage(input, interp, lh_map, rh_map)');
    return
end
